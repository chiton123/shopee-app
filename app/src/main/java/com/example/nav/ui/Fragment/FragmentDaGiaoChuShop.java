...
import com.example.nav.ui.Adapter.DaGiaoChuShopAdapter;
...
public class FragmentDaGiaoChuShop extends Fragment {
    ListView listView;
    DaGiaoChuShopAdapter adapter;
    ArrayList<GioHangChoLayHang> arrayList;
    String urldagiao = MainActivity.urldagiaochushop;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_dagiaochushop, container, false);
        listView = (ListView) view.findViewById(R.id.listviewdagiaochushop);
        arrayList = new ArrayList<>();
        adapter = new DaGiaoChuShopAdapter(getActivity(), arrayList);
