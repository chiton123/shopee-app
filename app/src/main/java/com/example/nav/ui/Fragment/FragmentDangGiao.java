...
import com.example.nav.ui.Adapter.DangGiaoNguoiMuaAdapter;
...
public class FragmentDangGiao extends Fragment {
    ...
    DangGiaoNguoiMuaAdapter adapter;
    String urldanggiao = MainActivity.urldanggiao;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_danggiao, container, false);
        listView = (ListView) view.findViewById(R.id.listviewdanggiaonguoimua);
        arrayList = new ArrayList<>();
        adapter = new DangGiaoNguoiMuaAdapter(getActivity(), arrayList);
